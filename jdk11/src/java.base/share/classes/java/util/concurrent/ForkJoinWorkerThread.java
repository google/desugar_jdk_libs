...
public class ForkJoinWorkerThread extends Thread {
    ...
    ForkJoinWorkerThread(ForkJoinPool pool, ClassLoader ccl) {
        ...
        ThreadLocalRandomHelper.setInheritedAccessControlContext(this, INNOCUOUS_ACC);
        this.pool = pool;
        this.workQueue = pool.registerWorker(this);
    }
    ...
    ForkJoinWorkerThread(ForkJoinPool pool,
        ...
        super.setContextClassLoader(ccl);
        ThreadLocalRandomHelper.setInheritedAccessControlContext(this, acc);
        ThreadLocalRandomHelper.eraseThreadLocals(this); // clear before registering
        this.pool = pool;
        this.workQueue = pool.registerWorker(this);
    }
    ...
    static final class InnocuousForkJoinWorkerThread extends ForkJoinWorkerThread {
        ...
        void afterTopLevelExec() {
            ThreadLocalRandomHelper.eraseThreadLocals(this);
        }
