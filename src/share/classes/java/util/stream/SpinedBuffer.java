...
class SpinedBuffer<E>
            ...
            public Spliterator<E> trySplit() {
                if (splSpineIndex < lastSpineIndex) {
                    ...
                    if (t == 0)
                        ...
                        Spliterator<E> ret = Arrays8.spliterator(splChunk, splElementIndex, splElementIndex + t);
                        splElementIndex += t;
                        return ret;
                    }
                }
    ...
    abstract static class OfPrimitive<E, T_ARR, T_CONS>
         ...
         * @since 1.8
         */
        // for desugar: copied from Iterable so we don't need to desugar Iterable itself for now
        @Override
        public Spliterator<E> spliterator() {
        ...
        public Spliterator.OfInt spliterator() {
            class Splitr extends BaseSpliterator<Spliterator.OfInt>
                ...
                Spliterator.OfInt arraySpliterator(int[] array, int offset, int len) {
                    return Arrays8.spliterator(array, offset, offset+len);
                }
            }
            return new Splitr(0, spineIndex, 0, elementIndex);
        }
